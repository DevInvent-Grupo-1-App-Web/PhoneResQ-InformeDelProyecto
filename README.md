...
Enlace de exposición de la entrega TF:  [Exposición TF - PhoneResQ](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20211d744_upc_edu_pe/EfHXN_opS_JKlO5RQt2s-I4B3D2Tug1HwB-iu5qbIRPegg?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0RpcmVjdCJ9fQ&e=4S9P9T)
...
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Participa en equipos multidisciplinarios con eficacia, eficiencia y objetividad, en el marco de un proyecto en soluciones de ingeniería de software.  | **Diego Fabian Cancho Coila** <br> <br> TB1 <br><br> - Después de deliberar sobre el tema central del proyecto, tomamos en cuenta las opiniones de todos los miembros del equipo. Luego, coordinamos la frecuencia y el horario de nuestras reuniones según la disponibilidad de cada uno. <br><br> TP1 <br> Durante el Sprint 2, el equipo se reunió en una sesión de planificación en Discord para establecer los objetivos y user stories. Luego, los miembros del equipo, utilizando Visual Studio Code y Git, colaboraron en el desarrollo de las funcionalidades planificadas, creando branches y realizando commits. Finalmente, se llevó a cabo una revisión del sprint para presentar y revisar las funcionalidades desarrolladas.<br><br> TB2<br>  - El equipo trabajó de manera colaborativa durante el Sprint, utilizando Visual Studio Code y Git para gestionar el código y realizar commits <br> - Se aprobaron los pull requests generados como resultado de las acciones colaborativas. <br> - Se llevaron a cabo reuniones de Sprint Planning y Sprint Review para asegurar la eficacia y eficiencia en la ejecución del proyecto. <br><br> TF <br> - Coordiné reuniones periódicas con los miembros del equipo para evaluar el progreso del proyecto y discutir posibles mejoras. <br> - Implementé metodologías ágiles, como Scrum, para organizar y gestionar las tareas del equipo de manera eficiente.  <br><br> **Arenas Conde, José Anthony** <br> <br> TB1 <br><br> Se realizaron dos reuniones semanales para compartir dudas, sugerencias y avances. Además, se concretó la repartición de responsabilidades de manera equitativa. <br> TP1 <br> La colaboración efectiva del equipo se reflejó en la reunión de planificación del Sprint 2, realizada en Discord. A partir de esta reunión, se distribuyeron las user stories entre los miembros del equipo, quienes utilizaron Visual Studio Code y Git para desarrollar y gestionar el código de manera eficiente. Al finalizar el sprint, se llevó a cabo una revisión exitosa para demostrar el progreso alcanzado. <br><br> TB2 <br>  - Se utilizó Visual Studio Code y Git para la gestión del código y la colaboración entre los miembros del equipo. <br> - Se realizaron reuniones de Sprint Planning para definir los objetivos del Sprint y asignar tareas. <br> - Se llevaron a cabo revisiones de código y se aprobaron los pull requests. <br><br> TF <br> - Participé activamente en discusiones técnicas para abordar desafíos específicos, brindando soluciones basadas en mi experiencia en el desarrollo de software. <br> - Lideré sesiones de lluvia de ideas para identificar posibles obstáculos en el proyecto y trabajé en estrategias para superarlos. <br><br> **Oscar Sebastian Nicolas Moreno Carmona** <br><br> TB1   <br><br> - Se coordinó con el equipo las fechas para la entrega de avances, las reuniones, las partes que cada uno tenía que realizar. De manera que, se tuvo un desarrollo óptimo de la TB1 <br><br> TP1 <br> <br> En el marco del Sprint 2, el equipo se reunió en una sesión de planificación a través de Discord para definir con claridad los objetivos y las user stories a abordar. A lo largo del sprint, se destacó la eficiencia en la colaboración, con los miembros asignados a tareas específicas utilizando Git y Visual Studio Code para trabajar de manera conjunta en el desarrollo. La revisión del sprint evidenció el cumplimiento de las metas establecidas.<br><br> TB2 <br>  - Se llevaron a cabo reuniones de planificación de Sprint y revisiones para asegurar la eficacia y eficiencia en el proyecto. <br> - Se realizaron reuniones de Sprint Planning para definir los objetivos del Sprint y asignar tareas <br><br> TF <br> - Fomenté un ambiente de trabajo inclusivo, donde las ideas y perspectivas diversas fueron valoradas y consideradas en la toma de decisiones del proyecto. <br><br> **Samuel Rolando Chamorro Torres** <br><br> TB1 <br><br> - Seleccionamos el tema central del proyecto tras tomar en cuenta las perspectivas de cada integrante del equipo. Posteriormente, organizamos la frecuencia y horarios de nuestras reuniones de acuerdo con la disponibilidad de todos los participantes. <br><br> TP1 <br> La participación cohesionada del equipo se manifestó en la planificación del Sprint 2, que se llevó a cabo en Discord. La distribución de tareas y el desarrollo colaborativo en Visual Studio Code con Git permitieron una ejecución eficiente de las user stories. La revisión final del sprint destacó el trabajo en equipo y la objetividad en la implementación de funcionalidades.<br><br> TB2 <br>  -La colaboración se llevó a cabo utilizando Visual Studio Code y Git para gestionar el código y realizar commits. <br> - Se realizaron reuniones de planificación de Sprint y revisiones para garantizar la eficacia y eficiencia en el proyecto <br> - Los pull requests fueron revisados y aprobados como parte del proceso de colaboración. <br><br> TF <br> - Implementé un sistema de control de versiones robusto para gestionar cambios en el código de manera eficiente y evitar conflictos <br> - Colaboré estrechamente con los desarrolladores front-end y otros miembros del grupo para asegurar la integración sin problemas del back-end con el front-end. <br><br> | TB1 <br> Elegimos el tema central del proyecto, escuchando opiniones de todos los integrantes del equipo, luego realizamos los acuerdos de la cantidad de reuniones y el horario adaptado a la disponibilidad de todos, al final se acordaron plazos de entrega y la repartición de responsabilidades <br> <br> TP1 <br> El equipo no solo desarrolló funcionalidades relacionadas con el sector empresarial de interés, sino que también documentó adecuadamente los servicios y realizó un despliegue exitoso en un entorno de producción. Esto demuestra un conocimiento práctico del dominio de aplicación de la solución de software. <br> <br> TB2 <br> <br> El equipo de desarrollo ha demostrado una colaboración efectiva y eficiente en un entorno multidisciplinario a través de reuniones de Sprint Planning, el uso de Visual Studio Code y Git para gestionar commits y la revisión de pull requests. Esto refleja una participación sólida en equipos multidisciplinarios en el contexto de proyectos de ingeniería de software. <br><br> TF <br> - En el desarrollo del proyecto, nuestro equipo adoptó un enfoque colaborativo y eficiente, cumpliendo con el criterio de participar en equipos multidisciplinarios de manera efectiva. Coordinamos reuniones regulares, implementamos metodologías ágiles, y fomentamos una comunicación abierta. La terminación exitosa del back-end y front-end, junto con la resolución de errores anteriores, reflejan nuestra capacidad para trabajar de manera cohesionada y objetiva, asegurando la calidad del producto final. <br>|
| Conoce al menos un sector empresarial o dominio de aplicación de soluciones de software. |  **Diego Fabian Cancho Coila** <br> <br> TB1 <br> <br> -Después de colaborar juntos, ahora tenemos una visión general sobre cómo funciona el sector de logística en una empresa, con un conocimiento fundamental de cómo se implementan las soluciones de software en situaciones reales <br> TP1 <br> Durante el desarrollo del Sprint 2, el equipo implementó funcionalidades específicas del sector empresarial al que se dirige la solución de software. Además, se documentaron detalladamente los endpoints del servicio relacionados con este sector, proporcionando una visión completa de la aplicación. Finalmente, se logró el despliegue exitoso en Google Firebase, lo que demuestra un conocimiento práctico del dominio empresarial. <br><br> TB2<br>  El equipo ha implementado el Front-End de una aplicación web para la gestión de reparaciones de teléfonos, lo que demuestra conocimiento en el dominio de servicios de reparación de teléfonos. Esto indica que el equipo está trabajando en un sector empresarial específico. <br><br> TF <br> - Desarrollé soluciones personalizadas que abordaran los problemas específicos del sector, proporcionando así un valor añadido a la aplicación. <br> - Investigé y adquirí un profundo conocimiento del sector empresarial al que se destinaba la aplicación, comprendiendo sus desafíos y requisitos específicos. <br><br> **Arenas Conde, José Anthony** <br> <br> TB1 <br><br>  - Luego del trabajo conjunto, se tiene una idea general de cómo es el trabajo en el sector de logística de una empresa, teniendo una comprensión básica de cómo se aplican las soluciones de software en un contexto real .<br><br> TP1 <br> El equipo demostró su comprensión del sector empresarial al incorporar funcionalidades relevantes en el desarrollo del Sprint 2. La documentación detallada de los servicios, junto con el despliegue en Google Firebase, subraya la familiaridad del equipo con el dominio de aplicación de la solución de software.  <br><br> TB2<br>  Se desarrolló una aplicación web destinada al sector de reparación de celulares y servicios técnicos.<br> Se llevaron a cabo entrevistas de validación con técnicos de reparación de celulares y usuarios para comprender las necesidades y requisitos específicos de este sector. <br><br> TF <br> - Adapté la interfaz de usuario y la funcionalidad de la aplicación para satisfacer las necesidades específicas del dominio de aplicación. <br> - Realicé un análisis detallado del dominio de aplicación de la solución de software, identificando oportunidades para mejoras y optimizaciones. <br><br> **Oscar Sebastian Nicolas Moreno Carmona** <br><br> TB1<br> <br> - Como equipo, hemos realizado el trabajo de gran parte del área de requerimientos de lo sería una empresa de software. Por ello, hemos realizado muchos avances para tener un buen producto.<br><br>TP1<br> Durante el Sprint 2, el equipo no solo implementó funcionalidades específicas del sector empresarial, sino que también documentó minuciosamente los servicios relacionados con este sector. El despliegue exitoso en Google Firebase fue el punto culminante que respaldó el conocimiento aplicado en este dominio. <br><br> TB2<br> Las preguntas de las entrevistas a técnicos de reparación de celulares y usuarios muestran un entendimiento del dominio de aplicaciones para programar reparaciones de celulares y recopilar comentarios relevantes. <br> El equipo muestra un conocimiento sólido del dominio de aplicación de soluciones de software relacionadas con la reparación de celulares. <br><br> TF <br> - Realicé estudios de mercado para comprender la competencia y posicionar la solución de software de manera efectiva en el mercado. <br><br>  **Samuel Rolando Chamorro Torres** <br><br> TB1 <br><br> - Después de colaborar en conjunto, se ha desarrollado una comprensión general sobre las operaciones en el ámbito de la logística empresarial, adquiriendo conocimientos fundamentales acerca de la implementación de software en situaciones reales. <br><br> TP1 <br> El equipo se destacó en la incorporación de funcionalidades relacionadas con el sector empresarial durante el Sprint 2. La documentación exhaustiva de los servicios y el exitoso despliegue en Google Firebase reflejan un conocimiento sólido del dominio de aplicación de la solución de software.  <br><br> TB2<br> Se crearon funcionalidades y características en la aplicación que se alinean con las necesidades identificadas en el sector. <br> El equipo muestra un conocimiento sólido del dominio de aplicación de soluciones de software relacionadas con la reparación de celulares. <br><br> TF <br> - Adapté proactivamente la arquitectura de la aplicación para cumplir con los estándares y regulaciones específicos del dominio de aplicación. <br><br> <br>                                                                                                                                                                                                          | TB1 <br> Nos enfocamos en mantenernos fieles al marco de desarrollo SCRUM, usando las técnicas y estrategias que tanto caracterizan a este framework para obtener los mejores resultados posibles.    <br> <br> TP1 <br> En general, el equipo demostró una colaboración efectiva y un conocimiento aplicado tanto en la ingeniería de software como en el dominio empresarial específico. El Sprint 2 se completó satisfactoriamente, logrando el objetivo de desplegar la primera versión del frontend en Google Firebase. <br> <br> TB2 <br> <br> El equipo ha demostrado un sólido conocimiento en el dominio de aplicaciones de software, específicamente en el sector de reparación de teléfonos. Las funcionalidades implementadas en la aplicación web reflejan una comprensión profunda de las necesidades de los usuarios en este dominio. La aplicación está diseñada para ser útil y efectiva en el sector empresarial de reparación de teléfonos <br><br> TF <br> - Nuestra comprensión profunda del sector empresarial objetivo se refleja en cada etapa del desarrollo. Investigamos a fondo sus desafíos, establecimos conexiones valiosas, y adaptamos la aplicación para satisfacer necesidades específicas. La participación activa en eventos del sector y la continua optimización basada en retroalimentación del usuario muestran nuestro compromiso con la excelencia en soluciones de software adaptadas a un dominio específico. <br> |
...
![integrante-euipo2.png](Doc/img/2.png)

![integrante-euipo3.png](Doc/img/3.png)

![integrante-euipo4.png](Doc/img/4.png)
...
![Stakeholders diagram](Doc/img/Stakeholders_diagram.png)
...
<p align="center">
  <img src="/Doc/img/Entrevista2-usuario.jpg" width="450">
</p>
...
<p align="center">
  <img src="/Doc/img/Entrevista1-tecnico.jpg" width="450">
</p>
...
<p align="center">
  <img src="/Doc/img/Entrevista2-tecnico.jpg" width="450">
</p>
...
<p align="center">
  <img src="/Doc/img/Entrevista3-tecnico.jpg" width="450">
</p>
...
<p align="center">
  <img src="/Doc/img/UserPersona-Usuario.jpg" width="450">
</p>

**Imagen 2: User Persona del segmento Técnico**

<p align="center">
  <img src="/Doc/img/UserPersona-Tecnico.jpg" width="450">
</p>
...
<p align="center">
  <img src="/Doc/img/Customerjourney-map-Usuario.png" width="450">
</p>

**Imagen 4: Journey Mapping del Técnico.**  

<p align="center">
  <img src="/Doc/img/Customerjourney-técnico.png" width="450">
</p>
...
<p align="center">
  <img src="/Doc/img/EmpathyMap-Usuario.jpg" width="450">
</p>
...
<p align="center">
  <img src="/Doc/img/EmpathyMap-Técnico.jpg" width="450">
</p>
...
<p align="center">
  <img src="/Doc/img/AS-ISScenarios-Usuario.png" width="450">
</p>

**Imagen 8: As-is Scenario Mapping del Técnico.**

<p align="center">
  <img src="/Doc/img/AS-ISScenarios-tecnico.png" width="450">
</p>
...
![To be scenario mapping](Doc/img/ToBeScenarioMapping.jpg)<br>
...
![Impact mapping del proyecto](Doc/img/ImpactMapping.jpg)
...
<p align="center">
  <img src="/Doc/img/Typography.png" width="400">
</p>
...
<p align="center">
  <img src="/Doc/img/Colors.png" width="400">
</p>
...
<p align="center">
  <img src="/Doc/img/Spacing.png" width="400">
</p>
...
<p align="center">
  <img src="/Doc/img/Botton.png" width="400">
</p>
...
<p align="center">
  <img src="/Doc/img/Responsive.png" width="300">
</p>
...
<p align="center">
  <img src="/Doc/img/PatronZ.png" width="300">
</p>
...
<p align="center">
  <img src="/Doc/img/Landing-Page-Wireframe.png" width="450">
</p>
<p align="center">
...
<p align="center">
  <img src="/Doc/img/Landing-Page-MockUp.png" width="450">
  <br/>
...
<p align="center">
  <img src="/Doc/img/App-Wireframes.png" width="400">
</p>
...
<p align="center">
  <img src="/Doc/img/WireFlow-Diagram-1.png" width="400">
</p>
<br>
<p align="center">
  <img src="/Doc/img/WireFlow-Diagram-2.png" width="400">
</p>
<br>
<p align="center">
  <img src="/Doc/img/WireFlow-Diagram-3.png" width="400">
</p>
<br>
<p align="center">
  <img src="/Doc/img/WireFlow-Diagram-4.png" width="400">
</p>
<br>
...
<p align="center">
  <img src="/Doc/img/Mock-Ups-Aplicacion.png" width="400">
</p>
<br>
<p align="center">
  <img src="/Doc/img/Mock-UP-1.png" width="400">
</p>
<br>
<p align="center">
  <img src="/Doc/img/Mock-UP-2.png" width="400">
</p>
<br>
<p align="center">
  <img src="/Doc/img/Mock-UP-3.png" width="400">
</p>
<br>
...
<p align="center">
  <img src="/Doc/img/User Goal 1.png" width="400">
</p>
<br>
...
<p align="center">
  <img src="/Doc/img/User Goal 2.png" width="400">
</p>
<br>
...
<p align="center">
  <img src="/Doc/img/User Goal 3.png" width="400">
</p>
<br>
...
<p align="center">
  <img src="/Doc/img/User Goal 4.png" width="400">
</p>
<br>
...
<p align="center">
  <img src="/Doc/img/User Goal 5.png" width="400">
</p>
<br>
...
<p align="center">
  <img src="/Doc/img/User Goal 6.png" width="400">
</p>
<br>
...
<p align="center">
  <img src="/Doc/img/User Goal 7.png" width="400">
</p>
<br>
...
<p align="center">
  <img src="/Doc/img/User Goal 8.png" width="400">
</p>
<br>
...
<p align="center">
  <img src="/Doc/img/App-Web-Prototype.png" width="550">
</p>
...
![context-diagram.png](Doc/img/context-diagram.png)
...
![container-diagram.png](Doc/img/container-diagram.png)
...
![component-reparacion.png](Doc/img/component-reparacion.png)

**backtraking component diagram**

![component-backtraking.png](Doc/img/component-backtraking.png)

**security component diagram**

![component-seguridad.png](Doc/img/component-seguridad.png)

**calification component diagram**

![component-calification.png](Doc/img/component-calification.png)
...
<p align="center">
  <img src="/Doc/img/Diagrama-de-Objetos.jpeg" width="450">
</p>
...
<p align="center">
<img src="Doc/img/DatabaseDesign.png" width="500px">
<br/>
...
GitFlow es un flujo de trabajo para el control de versiones utilizando Git, que se utiliza comúnmente en proyectos de desarrollo de software. Está diseñado para facilitar la colaboración entre equipos y gestionar eficientemente las ramas del repositorio.
 ...
 <p align="center">
  <img src="/Doc/img/GitFlow.jpg" width="450">
 </p>
...
Para el desarrollo de la Landing Page de PhoneResQ, se ha usado HTML, CSS y JavaScript.
 ...
 <p align="center">
  <img src="/Doc/img/RepositoryLandingPage.jpg" width="450">
 </p>
...
Asimismo, para el despliegue realizamos los siguientes pasos:
 ...
 2. Cuando estemos en el apartado de “Settings” del repositorio, buscamos la opción “Pages”, que se encuentra en la esquina inferior izquierda y la seleccionamos.
   <p align="center">
  <img src="/Doc/img/RepositoryGitHubPages.jpg" width="450">
</p>
  3. Dentro de “Pages”, elegimos el “branch” que se publicará en el vínculo. De igual modo, debemos elegir la carpeta donde se localiza la información a publicar, en este caso la carpeta donde está almacenada la Landing Page.
   <p align="center">
  <img src="/Doc/img/BranchGitHubPages.jpg" width="450">
</p>
...
<p align="center">
  <img src="/Doc/img/DeployLandingPage.png" width="450">
</p>
...
<p align="center">
  <img src="/Doc/img/EvidenceExecutionLP.jpg" width="450">
</p>
...
## Conclusiones
 ...
 - El desarrollo de este proyecto ha sido un testimonio de la dedicación, colaboración y habilidades multidisciplinarias de nuestro equipo. Desde la concepción hasta la implementación final, cada miembro contribuyó de manera significativa, demostrando un compromiso inquebrantable con la excelencia y la eficiencia. La terminación exitosa del back-end y front-end, junto con las correcciones de entregas anteriores, resalta nuestra capacidad para superar desafíos y aprender de experiencias previas.
 - La comunicación abierta y transparente se convirtió en la columna vertebral de nuestro enfoque de trabajo, permitiendo la rápida identificación y resolución de problemas. La implementación de metodologías ágiles facilitó una gestión efectiva de tareas y plazos, asegurando un progreso constante.
 - Además, nuestra comprensión profunda del sector empresarial y la adaptabilidad de la solución de software para satisfacer sus necesidades específicas reflejan nuestro compromiso con la calidad y la relevancia en cada fase del proyecto. Este logro conjunto no solo fortalece nuestras habilidades técnicas, sino que también destaca nuestra capacidad para enfrentar desafíos de manera colaborativa y cumplir con los objetivos del proyecto de manera efectiva.
